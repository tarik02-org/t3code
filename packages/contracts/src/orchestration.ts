...
export const OrchestrationSubscribeThreadInput = Schema.Struct({
  threadId: ThreadId,
  /** Standard windowed snapshot size for upstream-compatible pagination. */
  turnLimit: Schema.optionalKey(
    PositiveInt.check(Schema.isLessThanOrEqualTo(ORCHESTRATION_THREAD_TURN_PAGE_MAX_LIMIT)),
  ),
  /** Fork-only bounded snapshot size for advanced message-history browsing. */
  messageTurnLimit: Schema.optionalKey(
    PositiveInt.check(Schema.isLessThanOrEqualTo(ORCHESTRATION_THREAD_TURN_PAGE_MAX_LIMIT)),
  ),
  /**
