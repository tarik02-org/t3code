 ...
 * has made one, otherwise the default for this build stage (on for canary,
 * nightly, and dev; off for production). Every consumer must read through this
 * rather than `settings.sidebarV2Enabled`, which is only meaningful alongside
