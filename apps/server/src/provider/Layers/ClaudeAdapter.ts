...
export const makeClaudeAdapter = Effect.fn("makeClaudeAdapter")(function* (
  ...
  const handleSystemMessage = Effect.fn("handleSystemMessage")(function* (
    ...
    // Undeclared-but-real subtypes are consumed intentionally without emitting,
    // otherwise they surface as spurious error rows in client work logs.
    // `background_tasks_changed` is a roster
