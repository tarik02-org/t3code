...
export const makeClaudeAdapter = Effect.fn("makeClaudeAdapter")(function* (
  ...
  const handleSystemMessage = Effect.fn("handleSystemMessage")(function* (
    ...
    // Consumed intentionally without emitting, otherwise it falls through to
    // the unknown-subtype warning and surfaces as spurious error rows in client
    // work logs. `background_tasks_changed` is a roster
