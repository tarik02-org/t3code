...
8. After all checks pass, comment `/promote`. The promotion workflow verifies the PR base SHA, checks, ancestry, and label, then force-updates `main`, comments the new SHA, finalizes the PR, and deletes the temporary branch.
